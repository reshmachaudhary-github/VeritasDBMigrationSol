// DBWrapper.cpp : Defines the exported functions for the DLL.
//
...
/************************************************************************
/* GetResults: display results of a select query
/*
/* Parameters:
    ...
    SQLSMALLINT cCols)
{
    ...
    do {
        ...
        else
        {
            ...
            // fetch the data row by row.   Ignore truncations
